...
const SavedList = props => (
  <Card style={{margin: "5%", padding: "1.5%", display: "flex", flexFlow: "row", boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)", backgroundColor: "#edf6f9", border: "solid 1px black"}}>
    ...
    <Button style={{width: "80px", height: "45px", marginLeft: "65%", boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)", backgroundColor: "#e63946", fontFamily: "'Krona One', sans-serif", fontSize: "0.8rem" }} onClick={clickToHome} >Home</Button>
